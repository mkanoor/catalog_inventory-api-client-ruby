...
# Unit tests for CatalogInventoryApiClient::CollectionMetadata
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CollectionMetadata' do
  before do
    # run before each test
    @instance = CatalogInventoryApiClient::CollectionMetadata.new
  end
  ...
  describe 'test an instance of CollectionMetadata' do
    it 'should create an instance of CollectionMetadata' do
      expect(@instance).to be_instance_of(CatalogInventoryApiClient::CollectionMetadata)
    end
  end
